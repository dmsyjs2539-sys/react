...
export default function AlertBox(props:AlertProps){
 ...
 //위에서 로딩과 에러를 걸러냈으므로
 //여기 도달한status는 무조건 success 상태로 타입 좁혀짐
